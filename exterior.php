...
<?php include("header.php"); ?>
    ...
    <section class="interiorFaq">
        <div class="column2" style="margin-bottom: 50px;">
            ...
            <div style="text-align: center;">
                <img loading="lazy" style="width: 80%;" src="images/exterior/main.jpg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting ">
            </div>
        </div>
        <hr>
        <div class="column2" style="margin-top: 50px; margin-bottom: 50px;">
            <div style="text-align: center;">
                <img loading="lazy" style="width: 80%;" src="images/exterior/nice.jpeg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting ">
            </div>
            <div>
                <h1>
        ...
        <div class="column2" style="margin-top: 50px; margin-bottom: 50px;">
            ...
            <div style="text-align: center;">
                <img loading="lazy" style="width: 80%;" src="images/exterior/primary.jpeg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting ">
            </div>
        </div>
        <hr>
        <div class="column2" style="margin-top: 50px;margin-bottom: 50px;">
            <div style="text-align: center;">
                <img loading="lazy" style="width: 70%;" src="images/exterior/backOfHome.jpg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting ">
            </div>
            <div>
                <h1>
        ...
        <div class="column2" style="margin-top: 50px; margin-bottom: 50px;">
            ...
            <div style="text-align: center;">
                <img loading="lazy" style="width: 60%;" src="images/exterior/sideAngle.jpg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting ">
            </div>
        </div>
        <hr>
        <div class="column2" style="margin-top: 50px; margin-bottom: 50px;">
            ...
            <div style="text-align: center;">
                <img loading="lazy" style="width: 40%;" src="images/exterior/reddoor.jpg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting ">
                <img loading="lazy" style="width: 40%;" src="images/exterior/new1.jpg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting ">
            </div>
            <div>
                <h1>
