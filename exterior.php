...
<?php include("header.php"); ?>
    ...
    <section id="section1" style="background-image: url(./images/exterior/secondary.jpeg);">
    ...
    <section class="section2Exterior">
        <div class="section2Shade" style="background-color: #22292885;">
            <div class="sec2Div" style="text-align: center !important;">
                ...
                <hr>
                <div class="ratDiv">
                    <p style="color: white;">Believe it or not, exterior home painting can more often be more challenging than interior painting, dealing with weather and logistics.  That is why it can be a bit of a challenge to find quality exterior painting companies for your home or commercial space. We know you want to use the right exterior painting contractor that is fast, affordable and efficient. </p>
                </div>
                <hr>
                <div class="ratDiv">
                    <p style="color: white;">We always take the necessary preparatory steps when you choose us as your outdoor house painters.  Our crews want to ensure that the only place paint lands is where you want it to.  When you are trying to find ways to lower your exterior house painting cost without sacrificing quality, we are the best choice for your needs each time.  Your satisfaction is our priority!</p>
                </div>
                <hr>
                <div class="ratDiv">
    ...
    <section class="interiorFaq">
        <div class="column2" style="margin-bottom: 50px;">
            <div>
                <h1>
                    Why should Euro Top Paint my home?
                </h1>
            ...
            <div style="text-align: center;">
                <img loading="lazy" style="width: 80%;" src="images/exterior/main.jpg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting LTD">
            </div>
        </div>
        <hr>
        <div class="column2" style="margin-top: 50px; margin-bottom: 50px;">
            <div style="text-align: center;">
                <img loading="lazy" style="width: 80%;" src="images/exterior/nice.jpeg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting LTD">
            </div>
            <div>
                <h1>
        ...
        <div class="column2" style="margin-top: 50px; margin-bottom: 50px;">
            <div>
                ...
                <p>Euro Top Painting's experienced interior and exterior house painters are ready to assist you every step of the way, from selecting and ordering paint colors and scheduling the painters, to completing your painting job flawlessly.
                </p>
            </div>
            <div style="text-align: center;">
                <img loading="lazy" style="width: 80%;" src="images/exterior/primary.jpeg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting LTD">
            </div>
        </div>
        <hr>
        <div class="column2" style="margin-top: 50px;margin-bottom: 50px;">
            <div style="text-align: center;">
                <img loading="lazy" style="width: 70%;" src="images/exterior/backOfHome.jpg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting LTD">
            </div>
            <div>
                <h1>
        ...
        <div class="column2" style="margin-top: 50px; margin-bottom: 50px;">
            <div>
                ...
                <p>Yes we do! Euro Top Painting can help with your vinyl or aluminium siding.
                </p>
            </div>
            <div style="text-align: center;">
                <img loading="lazy" style="width: 60%;" src="images/exterior/sideAngle.jpg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting LTD">
            </div>
        </div>
        <hr>
        <div class="column2" style="margin-top: 50px; margin-bottom: 50px;">
            ...
            <div style="text-align: center;">
                <img loading="lazy" style="width: 40%;" src="images/exterior/reddoor.jpg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting LTD">
                <img loading="lazy" style="width: 40%;" src="images/exterior/new1.jpg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting LTD">
            </div>
            <div>
                <h1>
    ...
    <section class="slideShow">
        ...
        <div class="row">
            <div class="column">
              ...
              <img class="galImg" loading="lazy" src="images/exterior/side3.jpg">
              <img class="galImg" loading="lazy" src="images/exterior/side5.jpg">
              <img class="galImg" loading="lazy" src="images/exterior/1572059148572-JPEG_20191025_230543_full_medium.jpg">
              <img class="galImg" loading="lazy" src="images/exterior/1572059146141-JPEG_20191025_230542_full_medium.jpg">
            ...
            <div class="column">
                ...
                <img class="galImg" loading="lazy" src="images/exterior/b2.jpg">
            ...
            <div class="column">
                ...
                <img class="galImg" loading="lazy" src="images/exterior/sideAngle.jpg">
                <img class="galImg" loading="lazy" src="images/exterior/b3.jpg">
            ...
            <div class="column">
                ...
                <img class="galImg" loading="lazy" src="images/exterior/side4.jpg">
                <img class="galImg" loading="lazy" src="images/exterior/b.jpg">
          ...
          <div class="slideshowContainer">
            <div class="slideshow-container">
                ...
                <div class="mySlides fade">
                    <img class="galImg" loading="lazy" src="images/exterior/side3.jpg" width="100%">
                    <div class="text"></div>
                  </div>
                ...
                <div class="mySlides fade">
                  <img class="galImg" loading="lazy" src="images/exterior/sideAngle.jpg" width="100%">
                  <div class="text"></div>
                </div>
                <div class="mySlides fade">
                    <img class="galImg" loading="lazy" src="images/exterior/side4.jpg" width="100%">
                    <div class="text"></div>
                  </div>
                
                <div class="mySlides fade">
                  <img class="galImg" loading="lazy" src="images/exterior/side5.jpg" width="100%">
                  <div class="text"></div>
                </div>
              
                <div class="mySlides fade">
                  <img class="galImg" loading="lazy" src="images/exterior/b2.jpg" width="100%">
                  <div class="text"></div>
                </div>
                <div class="mySlides fade">
                ...
                <div class="mySlides fade">
                  <img class="galImg" loading="lazy" src="images/exterior/b.jpg" width="100%">
                  <div class="text"></div>
                </div>
                <div class="mySlides fade">
                    <img class="galImg" loading="lazy" src="images/exterior/b3.jpg" width="100%">
                    <div class="text"></div>
                </div>
                ...
                <div class="mySlides fade">
                  <img class="galImg" loading="lazy" src="images/exterior/1572059148572-JPEG_20191025_230543_full_medium.jpg" width="100%">
                  <div class="text"></div>
                </div>
              
                <div class="mySlides fade">
                  <img class="galImg" loading="lazy" src="images/exterior/1572059146141-JPEG_20191025_230542_full_medium.jpg" width="100%">
                  <div class="text"></div>
                </div>
