...
<head>
    ...
    <title>VividCoat Painting LTD - High quality popcorn ceiling removal and painting</title>
...
<body>
    ...
    <section id="section1" style="background: url(./images/interior/ceilings/1.jpg) top center no-repeat;
    background-size: cover;">
        <div class="darkBG" style="background-color: rgba(170, 137, 94, 0.404);">
            <div class="anotherOne" >
                <h1 class="bigText">Ceiling Services</h1>
    ...
    <section class="section2ceilings">
        <div class="section2Shade" style="background-color: #a1965885;">
            <div class="sec2Div" style="text-align: center !important;">
                <h1 style="font-size: 30px;" class="white">Ceiling Service Contractors</h1>
                <hr>
                <div class="ratDiv">
                    <p style="color: white;">VividCoat painting LTD  provides stucco contracting services all throughout the Greater Toronto Area: We specialize in transforming your stucco ceiling/popcorn ceiling into a smooth ceiling with perfectly flush drywall, pot lights and a vibrant fresh painted finish.</p>
                </div>
                <hr>
                <div class="ratDiv">
                    <p style="color: white;">VividCoat Painting is highly experienced in the repair оf most ceiling and plaster textures. Wе do оur bеѕt tо work in a timеlу and сlеаn fаѕhiоn; removing debris and dоing our bеѕt to minimize duѕt, during and аftеr the repair/installation рrосеѕѕ. We take great саrе of our clients’ surroundings, always uѕing drop ѕhееtѕ and thoroughly cleaning work аrеаѕ during, and аftеr the repair/installation рrосеѕѕ itself.</p>
                </div>
                <hr>
                <div class="ratDiv">
    ...
    <section id="servicesCeiling">
        <div class="blur">
            <h1 style="font-size: 30px;color: white;"> Ceiling <span style="color: #fff;"> Services</span></h1>
            ...
            <div class="services">
                <div>
                    <h3><i style="color: #0eb448; font-size: 30px;" class="far fa-check-square"></i> Popcorn ceiling removal</h3>
                </div>
                <div>
                    <h3><i style="color: #0eb448; font-size: 30px;" class="far fa-check-square"></i> Ceiling resurfacing & skim coat </h3><br>
                </div>
                <div>
                    <h3><i style="color: #0eb448; font-size: 30px;" class="far fa-check-square"></i> ceiling Repairs</h3>
                </div>
                <div>
    ...
    <section class="interiorFaq">
        <div class="column2" style="margin-bottom: 50px;">
            <div>
                <h1>
                    My ceiling needs cleaning and also has some minor stains, and holes. Does VividCoat Painting include repairs?
                </h1>
                <p>Yes, absolutely we repair popcorn ceiling, stucco painting, Color Cunsulting, Ceiling resurfacing & skim coat.</p>
            </div>
            <div style="text-align: center;">
                <img loading="lazy" style="width: 80%;" src="images/interior/ceilings/9.jpg" alt="Would it be possible to revieve a free estimate before starting any work? VividCoat Painting LTD">
            </div>
        </div>
        <hr>
        <div class="column2" style="margin-top: 50px; margin-bottom: 50px;">
            <div style="text-align: center;">
                <img loading="lazy" style="width: 80%;" src="images/interior/Gallery/16.jpeg" alt="Would it be possible to revieve a free estimate before starting any work? VividCoat Painting LTD">
            </div>
            <div>
                <h1>
        ...
        <div class="column2" style="margin-top: 50px; margin-bottom: 50px;">
            <div>
                ...
                <p>You've probably seen the dust and debris that occur as a result of sanding and fine finishing of drywall work. However, when you're part of a team like VividCoat Painting (which is made up of decades of experience in the drywall and stucco business), you'll learn how to Avoid the mess, as well as know what's going to lead to the mess.
                </p>
            </div>
            <div style="text-align: center;">
                <img loading="lazy" style="width: 50%;" src="images/interior/ceilings/12.jpg" alt="Would it be possible to revieve a free estimate before starting any work? VividCoat Painting LTD">
            </div>
        </div>
        <hr>
        <div class="column2" style="margin-top: 50px;margin-bottom: 50px;">
            <div style="text-align: center;">
                <img loading="lazy" style="width: 70%;" src="images/interior/ceilings/11.jpg" alt="Would it be possible to revieve a free estimate before starting any work? VividCoat Painting LTD">
            </div>
            <div>
                <h1>
    ...
    <section class="slideShow">
        <h1 style="font-size: 30px;"><span style="color: #0eb448;">Ceiling</span> Gallery</h1>
        <div class="row">
            <div class="column">
              <img class="galImg" loading="lazy" src="images/interior/interiorpaitingmainimage.jpeg">
              ...
              <img class="galImg" loading="lazy" src="images/interior/ceilings/12.jpg">
              
            </div>
            <div class="column">
                <img class="galImg" loading="lazy" src="images/interior/Gallery/22.jpg">
                <img class="galImg" loading="lazy" src="images/interior/Gallery/1570765815499-JPEG_20191010_235014_full_medium.jpg">
                <img class="galImg" loading="lazy" src="images/interior/ceilings/5.jpeg">
                <img class="galImg" loading="lazy" src="images/interior/Gallery/7.jpg">
                <img class="galImg" loading="lazy" src="images/interior/ceilings/18.jpg">
            </div>

            <div class="column">
                <img class="galImg" loading="lazy" src="images/interior/ceilings/16.jpeg">
            ...
            <div class="column">
                ...
                <img class="galImg" loading="lazy" src="images/interior/ceilings/13.jpeg">
                <img class="galImg" loading="lazy" src="images/interior/ceilings/15.jpg">
          ...
          <div class="slideshowContainer">
            <div class="slideshow-container">
                ...
                <div class="mySlides fade">
                    <img class="galImg" loading="lazy" src="images/interior/interiorpaitingmainimage.jpeg" width="100%">
                    <div class="text"></div>
                  </div>
                ...
                <div class="mySlides fade">
                  <img class="galImg" loading="lazy" src="images/interior/ceilings/12.jpg" width="100%">
                  <div class="text"></div>
                </div>
                <div class="mySlides fade">
                ...
                <div class="mySlides fade">
                    <img class="galImg" loading="lazy" src="images/interior/Gallery/1570765815499-JPEG_20191010_235014_full_medium.jpg" width="100%">
                    <div class="text"></div>
                </div>
              
                <div class="mySlides fade">
                  <img class="galImg" loading="lazy" src="images/interior/ceilings/5.jpeg" width="100%">
                  <div class="text"></div>
                </div>
                <div class="mySlides fade">
                ...
                <div class="mySlides fade">
                  <img class="galImg" loading="lazy" src="images/interior/ceilings/13.jpeg" width="100%">
                  <div class="text"></div>
                </div>
              
                <div class="mySlides fade">
                  <img class="galImg" loading="lazy" src="images/interior/ceilings/15.jpg" width="100%">
                  <div class="text"></div>
                </div>
                <div class="mySlides fade">
                  <img class="galImg" loading="lazy" src="images/interior/ceilings/16.jpeg" width="100%">
                  <div class="text"></div>
                </div>
