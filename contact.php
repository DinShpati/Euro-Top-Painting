...
<?php include("header.php"); ?> 
    ...
    <section id="section5">
        ...
        <div id="section5Divs">
            ...
            <div>
                <br>
                <img loading="lazy" src="images/homestars.png" alt="Euro Top Painting  2 year gurantee" style="max-width: 33%;">
            </div>
            <div>
                <br>
                    <img loading="lazy" src="images/Homestars-best-of-2020-2-black.png" alt="Euro Top Painting  30 years in business" style="max-width: 33%;">
            </div>
            <div>
                <br>
                    <img loading="lazy" src="images/logo.png" alt="Euro Top Painting  30 years in business" style="max-width: 60%;">
            </div>
        </div>
    </section>
