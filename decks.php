...
<?php include("header.php"); ?>   
    ...
    <section class="interiorFaq">
        <div class="column2" style="margin-bottom: 50px;">
            ...
            <div style="text-align: center;">
                <img loading="lazy" style="width: 80%;" src="images/exterior/decks/1.jpg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting ">
            </div>
        </div>
        <hr>
        <div class="column2" style="margin-top: 50px; margin-bottom: 50px;">
            <div style="text-align: center;">
                <img loading="lazy" style="width: 80%;" src="images/exterior/backOfHome.jpg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting ">
            </div>
            <div>
                <h1>
        ...
        <div class="column2" style="margin-top: 50px; margin-bottom: 50px;">
            ...
            <div style="text-align: center;">
                <img loading="lazy" style="width: 80%;" src="images/exterior/b2.jpg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting ">
            </div>
        </div>
        <hr>
        <div class="column2" style="margin-top: 50px;margin-bottom: 50px;">
            <div style="text-align: center;">
                <img loading="lazy" style="width: 80%;" src="images/exterior/exteriorSection2.jpg" alt="Would it be possible to revieve a free estimate before starting any work? Euro Top Painting ">
            </div>
            <div>
                <h1>
