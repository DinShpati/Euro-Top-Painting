...
<footer>
        ...
        <div>
            ...
            <div class="socialMediBtnContainer">
                ...
                <a href="#" class="socialBtn2">
                    <div class="button button-2">
                        <i class="fab fa-pinterest-p" style="padding: 0 6px;"></i>
                    </div>
                </a>
                <a href="#" class="socialBtn2">
                    <div class="button button-2">
                        <i class="fab fa-instagram" style="padding: 0 3.5px;"></i>
                    </div>
                </a>
                <a href="#" class="socialBtn2">
                    <div class="button button-2">
                        <i class="fab fa-linkedin-in"style="padding: 0 2px;"></i>
                    </div>
                </a>
            </div>
        </div>
